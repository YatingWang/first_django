...
class QuestionMethodTests(TestCase):
  def test_was_published_recently_with_future_question(self):
    '''
    was_publisehd_recently() should return False for questions whose pub_date is in the future.
    '''
...
def create_question(question_text, days):
  '''
  Creates a qustion with the given 'question_text' published the given number of 'days' offset to now(negative for questions published in the past, positive for questions that have yet to be published).
  '''
...
class QuestionIndexDetailTests(TestCase):
  def test_detail_view_with_a_future_question(self):
    '''
    The detail view of a quesiton with a pub_date in the future should return a 404 not found.
    '''
